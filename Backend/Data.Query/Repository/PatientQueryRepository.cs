    ...
    public class PatientQueryRepository : BaseQueryRepository, IPatientQueryRepository
    {
        ...
        public GetListClinicalHistoryByPatientIdModel GetListClinicalHistoryByPatientId(int id, int? doctorId, int limit, int page)
        {
            ...
            var result = ExecutionContext(connection =>
            {
                var total = connection.ExecuteScalar<int>(
                    countSql,
                    new { PatientId = id, DoctorId = doctorId });

                var list = connection.Query<ClinicalHistoryModel,
                                            PatientModel,
                                            DoctorModel,
        ...
        public PatientModel GetPatientByAuthUserId(int id)
        {
            ...
            var sql = @"SELECT  " + quote + "P" + quote + "." + quote + "nPatientId" + quote + " " + quote + "Id" + quote +
                     ...
                     " INNER JOIN " + quote + "ClientZone" + quote + " " + quote + "PZ" + quote +
                     " ON " + quote + "PZ" + quote + "." + quote + "nClientZoneId" + quote + " = " + quote + "P" + quote + "." + quote + "nPatientZoneId" + quote +
                     " WHERE " + quote + "P" + quote + "." + quote + "nAuthUserId" + quote + " = @AuthUserId";
            ...
            var values = ExecutionContext(connection =>
            {
                var returnVale = connection.Query<PatientModel,
                    ...
                    new { AuthUserId = id }, // 🔥 AQUÍ está la corrección
