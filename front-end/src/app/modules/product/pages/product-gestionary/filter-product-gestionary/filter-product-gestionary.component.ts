...
@Component({
  selector: 'filter-product-gestionary',
  templateUrl: './filter-product-gestionary.component.html',
  styleUrls: ['./filter-product-gestionary.component.scss']
})
export class FilterProductGestionaryComponent {
