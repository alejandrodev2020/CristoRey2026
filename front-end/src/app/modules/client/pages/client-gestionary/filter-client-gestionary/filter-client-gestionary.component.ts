...
@Component({
  selector: 'filter-client-gestionary',
  templateUrl: './filter-client-gestionary.component.html',
  styleUrls: ['./filter-client-gestionary.component.scss']
})
export class FilterClientGestionaryComponent {
