...
@Component({
  ...
  styleUrls: ['./store-client.component.scss']
})
export class StoreClientComponent implements OnInit ,AfterViewInit {
      ...
      .then(position => {
        ...
        if (typeof lat === 'number' && typeof lng === 'number') {
          ...
          setTimeout(() => {
            ...
            // Crear el marcador y asociar el evento dragend
            this.movableMarker = new google.maps.Marker({
              position: initialPosition,
              map: map,
              draggable: true
