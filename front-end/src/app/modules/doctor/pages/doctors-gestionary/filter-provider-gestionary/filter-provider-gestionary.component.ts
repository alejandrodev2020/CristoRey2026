...
@Component({
  selector: 'filter-provider-gestionary',
  templateUrl: './filter-provider-gestionary.component.html',
  styleUrls: ['./filter-provider-gestionary.component.scss']
})
export class FilterProviderGestionaryComponent {
