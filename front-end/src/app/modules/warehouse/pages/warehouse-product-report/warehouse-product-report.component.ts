...
@Component({
  selector: 'app-warehouse-product-report',
  templateUrl: './warehouse-product-report.component.html',
  styleUrls: ['./warehouse-product-report.component.scss']
})
export class WarehouseProductReportComponent implements OnInit  {
  form: FormGroup;
