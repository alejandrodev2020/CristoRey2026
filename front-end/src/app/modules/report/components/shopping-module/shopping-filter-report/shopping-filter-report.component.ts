...
@Component({
  selector: 'shopping-filter-report',
  templateUrl: './shopping-filter-report.component.html',
  styleUrls: ['./shopping-filter-report.component.scss']
})
export class ShoppingFilterReportComponent implements AfterViewInit{
