...
@Component({
  selector: 'app-options-gestionary',
  templateUrl: './options-gestionary.component.html',
  styleUrls: ['./options-gestionary.component.scss']
})
export class OptionsGestionaryComponent implements AfterViewInit {
  form: FormGroup;
