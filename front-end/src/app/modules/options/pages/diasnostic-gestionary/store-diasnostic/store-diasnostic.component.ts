...
@Component({
  selector: 'app-store-diasnostic',
  templateUrl: './store-diasnostic.component.html',
  styleUrls: ['./store-diasnostic.component.scss']
})
export class StoreDiasnosticComponent  implements OnInit {
    ...
    save(): void {
        ...
        if (this.isValidForm()) {
            ...
            this.isSaving = true
            this.service.storeDiasnostic(data).subscribe((resp) => {
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
