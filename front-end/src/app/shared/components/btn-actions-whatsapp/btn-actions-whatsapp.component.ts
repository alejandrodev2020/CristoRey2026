...
@Component({
  selector: 'btn-actions-whatsapp',
  templateUrl: './btn-actions-whatsapp.component.html',
  styleUrls: ['./btn-actions-whatsapp.component.scss']
})
...
export class BtnActionsWhatsappComponent {
