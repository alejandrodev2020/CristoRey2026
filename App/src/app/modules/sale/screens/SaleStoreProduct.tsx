...
import {createSaleStoreProductStyle} from './SaleStoreProductStyle';
...
type Props = DrawerScreenProps<DrawerParamList, 'SaleStoreProduct'>;

export default function SaleStoreProductScreen({route, navigation}: Props) {
  ...
  const styles = createSaleStoreProductStyle(theme);
